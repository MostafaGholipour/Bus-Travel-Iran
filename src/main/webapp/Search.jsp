...
<div class="parent-div">
  <form name="form" action="BusResult" method="post" onsubmit="return validateForm()">
   <input type="hidden" name="customerId" value="<%=request.getSession().getAttribute("customerId")%>">
    ...
    <div class="mb-3 my-3">
      ...
      <select class="form-select" aria-label="Default select example" id="InputDestination" dir="rtl" name="destination">
        <option selected>please Select</option>
        <option value="Tehran">Tehran</option>
        <option value="Mashhad">Mashhad</option>
        <option value="Tabriz">Tabriz</option>
